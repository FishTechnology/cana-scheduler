...
public class StartWithCustomCondition extends Condition {
    private final String expectedValue;

    public StartWithCustomCondition(String expectedValue) {
        super("value");
    ...
    public CheckResult check(Driver driver, WebElement element) {
        ...
        return new CheckResult(CustomHtml.html.startWith(value, this.expectedValue), actualValue);
    }
