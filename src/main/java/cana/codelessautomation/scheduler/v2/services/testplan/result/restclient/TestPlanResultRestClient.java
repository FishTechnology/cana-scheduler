package cana.codelessautomation.scheduler.v2.services.testplan.result.restclient;
...
@Path("/api")
@RegisterRestClient
public interface TestPlanResultRestClient {
    @PUT
    @Path("scheduleIterationIds/{scheduleIterationId}/testPlanResults/{testPlanResultId}/status")
    List<ErrorMessageModel> updateTestPlanResultStatus(@Valid @PathParam Long scheduleIterationId,
